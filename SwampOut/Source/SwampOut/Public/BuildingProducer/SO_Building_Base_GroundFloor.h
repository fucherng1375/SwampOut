...
public:
	...
	TArray<TObjectPtr<class ASO_Building_Base_Level>> CacheLevel = TArray<TObjectPtr<class ASO_Building_Base_Level>>();
#pragma endregion
...
public:
	...
	void OnSpawningLevel(ASO_Building_Base_Level* Level);
